					...
					<div class="box_border">
		            	...
		            	<div class="row">
		            		<?php
		            			...
		            			$str_district = "SELECT DISTRICT_NAME FROM district 
		            			WHERE DISTRICT_ID = :param_id_district";
		            			...
		            			$str_amphur = "SELECT AMPHUR_NAME FROM amphur WHERE AMPHUR_ID = :param_id_amphur";
		            			...
		            			$str_province = "SELECT PROVINCE_NAME FROM province 
		            			WHERE PROVINCE_ID = :param_id_province";
		            			...
		            			$record_district['DISTRICT_NAME']." ".$record_amphur['AMPHUR_NAME']." ".
		            			$record_province['PROVINCE_NAME']." ".$record_order_address['zipcode'];
		            	...
		            	<div class="row" style="margin-top: 35px; margin-bottom: 35px; text-align: center;">
		            		<div class="col-12">
		            			<font style="font-size:18px;">ขอบพระคุณสำหรับคำสั่งซื้อ</font>
		            		</div>
		            		<div class="col-12">
		                        ...
		                        <div class="col-12">
		                            <font style="font-size:16px;">
		                            	โทรศัพท์ : 088 874 8720 อีเมล contactus.enr@gmail.com
		                        	</font>
		                        </div>
