<div class="row" style="background-color: #f75755; padding-top: 1em; padding-bottom: 1emว">
    <div class="col-12">
        <h3 class="font_header font_yellow" style="font-weight: bold;"><i class="fas fa-bolt"></i> Hot Deal</h3>
    </div>
</div>
