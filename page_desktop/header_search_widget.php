<nav class="sticky-top" style="margin:0px; padding: 0px; background-color: #FFFFFF">
<div class="container-fluid">
	<div class="container">
		<div class="row" style="height: 100px;">
			<div class="col-1" style="padding-top: 1.6em;">
				<?php include_once("page_desktop/menu_hamburger.php"); ?>
			</div>
			<div class="col-3">
				<a href="<?php echo URL; ?>">
				<img src="<?php echo URL_IMG;?>images/PM-LOGO-1.png" style="max-height: 5.8em; padding-top: 25px; padding-bottom: 20px;" ></a>&nbsp;
			</div>
			...
			<div class="col-2" style="text-align: right;">
				<div style="padding-top: 43px;">
					...
					<a href="<?php echo $iscart_url;?>">
						...
						style="position: absolute; top:30px; right:15px; background-color: #ffd21d">
						<?php echo $iscart; ?>
						</span>
