...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210519_03865b646edc6ecc8909_20210519064302_archive.zip';
	const ARCHIVE_SIZE		 = '37978895';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '03865b6-19064302';
    const SECONDARY_PACKAGE_HASH = 'e200358-19064302';
	const VERSION			 = '1.4.0';
