<?php
	...
	if($status == true){
		$order_payment_array = array(
			...
			":param_payment_methods" => "transfer_banking"
		);

		$insert_order_payment = "insert into order_payment 
		(id_order, name, email, phone, id_bank, transfer_amount, payment_datetime, payment_slip, detail, payment_methods) 
		values (:param_id_order, :param_name, :param_email, :param_phone, :param_id_bank, :param_transfer_amount, 
		:param_payment_datetime, :payment_slip, :param_detail, :param_payment_methods)";
